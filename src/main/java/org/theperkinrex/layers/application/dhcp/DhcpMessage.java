...
public class DhcpMessage {
    ...
    public static DhcpMessage dhcpOffer(int xid, LinkAddr clientHaddr, IPv4Addr offeredAddr, IPv4Addr.Mask subnetMask,
                                        int leaseTime, IPv4Addr serverAddr, short secs) {
        DhcpOption[] opt = new DhcpOption[]{DhcpMessageType.DHCPOFFER, new ServerIdentifier(serverAddr),
                new IpLeaseTime(leaseTime), new SubnetMask(subnetMask)
        };

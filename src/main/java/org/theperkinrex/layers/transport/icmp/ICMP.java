...
public interface ICMP<A extends NetAddr> {
	byte echo(int id, int seq, A dest) throws InterruptedException, RouteNotFoundException;

	A limitedTTLSegment(TransportSegment ts, A dest, byte ttl) throws InterruptedException, RouteNotFoundException;
}
